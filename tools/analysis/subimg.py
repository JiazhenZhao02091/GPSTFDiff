...
if __name__ == '__main__':
    ...
    argparser.add_argument('--output_dir', type=str, default='PPT/subimage/single', help='Output directory for single mode')
