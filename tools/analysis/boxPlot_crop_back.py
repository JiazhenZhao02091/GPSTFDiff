"""
功能:
    按 CDL 作物类别统计各模型在不同作物区域的 Bias、RMSE、CC、SAM，并绘制分组箱线图。
...
参数:
    ...
    pred_replace_rule (tuple[str, str]): 真实文件名到预测文件名的替换规则。
...
输出:
    输出 Figure_1_Error_Metrics.png 和 Figure_2_Quality_Metrics.png。
"""
import os
import sys
import re
...
def get_color_for_method(method_name):
    ...
    # Transformer/Mamba/Diffusion 等新架构 (低饱和绿色)
        ...
        return '#74C476'
    # ★ 强化的提出/关注方法 (高亮橘红色) ★
    elif m in ['ganstfm', 'swinstf', 'gpstfdiff', 'proposed']:
        return '#F56C42'  # 橘红色
    # 默认颜色
    return '#999999'
...
def main():
    ...
    out_dir = 'artifacts/image/box_plot_cropwise'
    ...
    pred_dirs_dict = {
        ...
        'FSDAF': '/home/zhaojiazhen/workspace/STF/STF/results/FSDAF/ML/patch',
        'FitFC': 'results/FitFC/ML/patch/FitFC_Results_L2',
        'stfdcnn': '/home/zhaojiazhen/workspace/STF/STF/results/stfdcnn/syy_setting~9/ML/inference~stage_1_SGD_1e-2~stage_2_SGD_1e-1/patch/imgs/stage_2/ML/save_img',
        'ganstfm': '/home/zhaojiazhen/workspace/STF/STF/results/ganstfm/syy_setting-9/ML/inference~Adam_1e-4/patch/imgs/ML/save_img',
        'stfgan': 'results/stfgan/syy_setting-9/ML/inference~stage_1~RMSProp~stage_2~RMSProp/patch/imgs/stage_2/ML/save_img',
        'opgan': '/home/zhaojiazhen/workspace/STF/STF/results/opgan/syy_setting-9/ML/inference~RMSProp/patch/imgs/ML/save_img',
        'swinstf': '/home/zhaojiazhen/workspace/STF/STF/results/swinstf/syy_setting-9/ML/inference~Adam_1e-4~StepLR_step_size-15_gamma_5e-1/patch/imgs/ML/save_img',
        'fsdformer': '/home/zhaojiazhen/workspace/STF/STF/results/fsdformer/syy_setting-9/ML/inferencer/patch/imgs/ML/save_img',
        ...
        'GPSTFDiff': '/home/zhaojiazhen/workspace/STF/STF/results/GPSTFDiff/lap/syy_setting-9/ML/inference/patch/imgs/ML/0/save_img',
    }
    ...
    for fig_id, (fig_name, split_metrics) in enumerate(layout_graphs.items()):
        ...
        legend_elements = [
            ...
            mpatches.Patch(color='#F56C42', label='Proposed (SwinSTFM/GPSTFDiff)')
        ]
