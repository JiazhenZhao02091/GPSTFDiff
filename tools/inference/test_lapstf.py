# python tools/inference/test_lapstf.py --congfig_path config/LapSTF/model4/CIA/inference_config.py
...
from src.inferencer.lapstf.model4.lapSTF_inferencer import Inferencer
import argparse
import importlib
import warnings
