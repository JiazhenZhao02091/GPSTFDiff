"""
   CUDA_VISIBLE_DEVICES="4" python tools/inference/test_dit.py --congfig_path  config/ditstf/syy_setting-9/model3/CIA/inference_config.py
   config/ditstf/syy_setting-9/model3/CIA/inference_config_l2.py
"""
import os
...
from src.inferencer.dit_inferencer_2 import Inferencer
import argparse
import importlib
import warnings
