# python tools/inference/test_stfdcnn.py --congfig_path config/stfdcnn/syy_setting-8/inference~stage_1_SGD_1e-2~stage_2_SGD_1e-1.py


# python tools/inference/test_stfdcnn.py --congfig_path config/stfdcnn/syy_setting~9/CIA/inference~stage_1_SGD_1e-2~stage_2_SGD_1e-1.py

# python tools/inference/test_stfdcnn.py --congfig_path config/stfdcnn/syy_setting~9/LGC/inference~stage_1_SGD_1e-2~stage_2_SGD_1e-1.py

import os

os.environ['CUDA_VISIBLE_DEVICES'] = '0'
os.environ['OMP_NUM_THREADS'] = '1'
from src.inferencer.stfdcnn_inferencer import Inferencer
import argparse
import importlib
import warnings
