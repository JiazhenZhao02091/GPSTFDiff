"""
    - python tools/inference/test_ditstf.py --congfig_path config/ditstf/syy_setting-9/CIA/inference.py
    - python tools/inference/test_ditstf.py --congfig_path config/ditstf/syy_setting-9/LGC/inference.py
"""
import os
...
from src.inferencer.ditstf_inferencer import Inferencer
import argparse
import importlib
import warnings
