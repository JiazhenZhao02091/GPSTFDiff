"""
    - python tools/train/train_ditstf.py --congfig_path config/ditstf/syy_setting-9/CIA/config.py
    - python tools/train/train_ditstf.py --congfig_path config/ditstf/syy_setting-9/LGC/config.py
"""
import os

os.environ["CUDA_VISIBLE_DEVICES"] = "4"    # cuda_visible_devices
...
from src.trainer.ditstf_trainer import Trainer
