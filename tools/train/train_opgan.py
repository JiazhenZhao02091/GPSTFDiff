# python tools/train/train_opgan.py --congfig_path config/opgan/syy_setting-8/RMSProp.py
# python tools/train/train_opgan.py --congfig_path config/opgan/syy_setting-8/RMSProp.py

# python tools/train/train_opgan.py --congfig_path config/opgan/syy_setting-9/CIA/RMSProp~w_change_1e-2.py
# python tools/train/train_opgan.py --congfig_path config/opgan/syy_setting-9/LGC/RMSProp~w_change_1e-2.py

# python tools/train/train_opgan.py --congfig_path config/opgan/STIL/RMSProp_1e-4_Step_250_gamma_1e-1.py
...
from src.trainer.opgan_trainer import Trainer
