"""
   CUDA_VISIBLE_DEVICES="" python tools/train/train_fsdformer.py --congfig_path  config/fsdformer/syy_setting-9/CIA/train_config.py
"""
import os
...
from src.trainer.fsdformer_trainer import Trainer
