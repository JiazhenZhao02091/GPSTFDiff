...
# measure_inference_time('GPSTFDiff (sampling_timesteps=10)', lambda: model.sample(M1_full, M1_full, M1_full) if hasattr(model, 'sample') else model(M1_full, M2_full, L1_full, L2_full)) 
# del model; torch.cuda.empty_cache()
