...
if __name__ == '__main__':
    LOCATION = 'ML'
    CDL_DIR = os.path.join(PROJECT_ROOT, 'data/spatio_temporal_fusion/ML/CDL_cropped')
    BASE_LOG_DIR = os.path.join(PROJECT_ROOT, 'results/crop_unet/all_methods_eval')
    os.makedirs(BASE_LOG_DIR, exist_ok=True)
    METHODS_DICT = {'starfm': os.path.join(PROJECT_ROOT, 'results/starfm/ML/full'), 'FSDAF': os.path.join(PROJECT_ROOT, 'results/FSDAF/ML/full'), 'FitFC': os.path.join(PROJECT_ROOT, 'results/FitFC/ML/full'), 'stfdcnn': os.path.join(PROJECT_ROOT, 'results/stfdcnn/ML/full'), 'ganstfm': os.path.join(PROJECT_ROOT, 'results/ganstfm/ML/full'), 'stfgan': os.path.join(PROJECT_ROOT, 'results/stfgan/ML/full'), 'opgan': os.path.join(PROJECT_ROOT, 'results/opgan/ML/full'), 'swinstf': os.path.join(PROJECT_ROOT, 'results/swinstf/ML/full'), 'fsdformer': os.path.join(PROJECT_ROOT, 'results/fsdformer/ML/full'), 'stfmamba': os.path.join(PROJECT_ROOT, 'results/stfmamba/ML/full'), 'stfdiff': os.path.join(PROJECT_ROOT, 'results/stfdiff/ML/full'), 'lapstfdiff': os.path.join(PROJECT_ROOT, 'results/LapSTFDiff/ML/full'), 'sa-stf': os.path.join(PROJECT_ROOT, 'results/SA_STF/ML/full')}
    ...
    if not dataset_split:
        print('从 syy_setting 获取失败，启用内置 fallback 配置...')
    ...
    for method_name, pred_dir in METHODS_DICT.items():
        evaluate_method(method_name=method_name, pred_dir=pred_dir, cdl_dir=CDL_DIR, dataset_split=dataset_split, model=model, device=CONFIG['device'], save_dir=BASE_LOG_DIR)
    print('\n 所有模型评估已全部完成！')
