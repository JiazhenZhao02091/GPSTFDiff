...
class Inferencer:
    ...
    def get_model_input(self, data_per_batch):
        ...
        ).view(b, c, self.patch_size, self.patch_size, -1)
    ...
    def inference_iter(
        ...
        for patch_idx in range(patch_num):
            fine_img_01_patch = model_input_patches_list[0][..., patch_idx]
            corase_img_02_patch = model_input_patches_list[1][..., patch_idx]
            corase_img_01_patch = model_input_patches_list[2][..., patch_idx]
            
            # FSDFormer expected input order
            model_input_list = [
                fine_img_01_patch,
                corase_img_02_patch,
                corase_img_01_patch,
