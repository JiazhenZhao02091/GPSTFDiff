...
class Inferencer:
    ...
    def before_inference_iter(self, data_per_batch):
        fine_img_01 = self.get_L1(data_per_batch)
        show_img_list = self.get_show_img_list(data_per_batch)
    ...
    def get_L1(self, data_per_batch):
        fine_img_01 = data_per_batch['fine_img_01'].to('cuda')  # 1, c, h, w
    ...
    def get_show_img_list(self, data_per_batch):
        show_img_list = [
    ...
    def inference_iter(
        ...
        reconstruction_fine_img = fine_img_01
        ...
        for metric in self.metric_list:
            ...
            self.val_tracker.update(metric.__name__, metric_value.item())
        self.txt_logger.info(msg)
