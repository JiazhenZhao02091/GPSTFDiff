...
from src.model.FSDFormer import Loss
...
class Trainer:
    ...
    def train_iter(self, iter_idx, model_input_list):
        ...
        coarse_img_01, coarse_img_02, fine_img_01, fine_img_02 = model_input_list
        outputs = self.model(fine_img_01, coarse_img_02, coarse_img_01)
        loss = self.loss_fn(outputs, fine_img_02, is_ds=False)
        loss.backward()
    ...
    def val_iter(
        ...
        with torch.no_grad():
            coarse_img_01, coarse_img_02, fine_img_01, fine_img_02 = model_input_list
            outputs = self.model(fine_img_01, coarse_img_02, coarse_img_01)
            pixel_loss = self.loss_fn(outputs, fine_img_02, is_ds=False)
