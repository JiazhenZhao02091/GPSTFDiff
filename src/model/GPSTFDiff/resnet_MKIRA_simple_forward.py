...
"""
    forward参数为 [noisy_fine_img_02, t, condition]
"""
...
# --------------------------
class PredNoiseNetMKIRA_forward(nn.Module):
    def __init__(
        self,
        dim: int = 64,
        init_dim: int = None,
    ...
    def forward(
        ...
        coarse_c2 = 6
        fine_c = 6
        coarse_img_01, coarse_img_02, fine_img_01 = torch.split(condtition, [coarse_c1, coarse_c2, fine_c], dim=1)
...
if __name__ == "__main__":
    ...
    out = net(noisy_f2, time, condition)
    print(out.shape)
