...
"""
    ...
    * cosine 余弦调度
    ...
    调用去噪网络的时候，传入参数为 [coarse_img_01, coarse_img_02, fine_img_01, noisy_fine_img_02, t, x_self_cond]
    这里使用的也是masked loss 的计算方式 默认就是使用了 l1 loss
"""
...
class GaussianDiffusion(nn.Module):
    def __init__(
        ...
        *,
        image_size,
        timesteps=1000,         # 训练时从 0 - 999 中随机采样时间步t，噪声添加的精细粒度
    ...
    def p_losses(
        self, coarse_img_01, coarse_img_02, fine_img_01, fine_img_02, t, mask, noise=None
    ):
        ...
        if self.use_mask_loss and mask is not None:
    ...
    def forward(self, coarse_img_01, coarse_img_02, fine_img_01, fine_img_02, mask):
        (
            b,
            c,
            h,
        ...
        # 返回值是损失
        return self.p_losses(coarse_img_01, coarse_img_02, fine_img_01, fine_img_02, t, mask)
