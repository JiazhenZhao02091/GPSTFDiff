...
class Diffusion(nn.Module):
    ...
    def ddim_sample(
        ...
        # 【新增】：生成与由条件图相等的全尺寸高斯噪声，并通过拉普拉斯金字塔抽取对应的各级高频本频噪声
        base_noise = torch.randn_like(fine_img_01)
        noise_x1, noise_x2, noise_x3 = self.laplacian_pyramid(base_noise, levels=3)
