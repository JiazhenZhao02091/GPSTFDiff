...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.num_heads = num_heads
        use_shortcut = False #always use shortcut
    ...
    def forward(self, coarse1, coarse2, fine1, noisy_fine2, t):
        """
        Forward pass of DiT.
        ...
        """
        x = torch.cat((coarse1, coarse2, fine1, noisy_fine2), dim=1)
    ...
    # def forward_stf(self, coarse1, coarse2, fine1, fine2):
    #     # image : N C H W 
    #     """
    #         返回 loss
    #     """
    ...
    #     # 1、生成噪声
    #     noise = torch.randn_like(fine2)
    #     # 2、加噪声
    #     noise_fine_2 = fine2 + noise # 简单相加
    #     # 3、预测噪声
    #     pred_noise_fine_2 = self.forward(noise_fine_2, t, dt = None)
    #     # 4、根据噪声计算损失
    #     loss = F.l1_loss(pred_noise_fine_2, noise)
    #     return loss
        pass
...
if __name__ == "__main__":
    ...
    # x = torch.randn(1, 24, 32, 32)
    coarse1 = torch.randn(1, 6, 256, 256)
    coarse2 = torch.randn(1, 6, 256, 256)
    fine1 = torch.randn(1, 6, 256, 256)
    noisy_fine2 = torch.randn(1, 6, 256, 256)
    t = torch.rand(1,)
    print(model(coarse1, coarse2, fine1, noisy_fine2, t).shape)
