...
class PredNoiseNet(nn.Module):
    def __init__(
        ...
        print("--- Use STFDifff PredNoiseNet ---")
        time_dim = dim * 4
    ...
    def forward(
        ...
        C = 6
        coarse_img_01 = condition[:, 0:C, :, :]
        coarse_img_02 = condition[:, C:2*C, :, :]
        fine_img_01 = condition[:, 2*C:3*C, :, :]
        # print(f"coarse_1 shape is {coarse_img_01.shape}, coarse_2 shape is {coarse_img_02.shape}, fine_img shape is {fine_img_01.shape}")
