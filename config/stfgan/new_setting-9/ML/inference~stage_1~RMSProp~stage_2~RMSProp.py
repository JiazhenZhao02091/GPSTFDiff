...
test_dataset = dataset_cls_func(
    dataset_name='ML',
    data_root='data/spatio_temporal_fusion/ML/private_data/new_setting-9/test/full',
...
checkpoint_stage_1_path = 'results/stfgan/new_setting-9/ML/stage_1~RMSProp/checkpoints/model_generator_epoch_499.pth'
checkpoint_stage_2_path = 'results/stfgan/new_setting-9/ML/stage_2~RMSProp/checkpoints/model_generator_epoch_499.pth'
