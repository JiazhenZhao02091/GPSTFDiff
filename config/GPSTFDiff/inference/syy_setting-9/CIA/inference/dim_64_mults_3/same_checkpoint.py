...
# from src.model.dit.model3_2_5.diffusion_inferencer import Diffusion
...
model = Diffusion(
    model_x3 = PredNoiseNetMKIRA_forward(dim=64, channels=6, out_dim=6, dim_mults=(1, 2, 4), use_mkira=True, mkira_up_indices=(1, 2), mkira_init_alpha=0.0),
    model_x2_x3 = PredNoiseNetMKIRA_forward(dim=64, channels=6, out_dim=6, dim_mults=(1, 2, 4), use_mkira=True, mkira_up_indices=(1, 2), mkira_init_alpha=0.0),
    model_x1_x2_x3 = PredNoiseNetMKIRA_forward(dim=64, channels=6, out_dim=6, dim_mults=(1, 2, 4), use_mkira=True, mkira_up_indices=(1, 2), mkira_init_alpha=0.0),
...
checkpoint_path_x1_x2_x3 = "/mnt/data1/zsh/workspace/stf/results/GPSTFDiff/syy_setting-9/CIA/results_MKIRA/checkpoints/best_model_epoch_499.pth"
checkpoint_path_x2_x3 = "/mnt/data1/zsh/workspace/stf/results/GPSTFDiff/syy_setting-9/CIA/results_MKIRA/checkpoints/best_model_epoch_499.pth"
checkpoint_path_x3 = "/mnt/data1/zsh/workspace/stf/results/GPSTFDiff/syy_setting-9/CIA/results_MKIRA/checkpoints/best_model_epoch_499.pth"
