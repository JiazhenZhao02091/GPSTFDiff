...
model = GaussianDiffusion(
    model=PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8), use_mkira=True, mkira_up_indices=(1, 2), mkira_init_alpha=0.0, fusion_mode="sub"),# cat sub
    image_size=256,
    timesteps=100,
