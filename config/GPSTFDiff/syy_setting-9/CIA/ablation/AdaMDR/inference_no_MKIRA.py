...
model = Diffusion(
    model_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8), use_mkira=False, mkira_up_indices=(1, 2, 3), mkira_init_alpha=0.0),
    model_x2_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8), use_mkira=False, mkira_up_indices=(1, 2, 3), mkira_init_alpha=0.0),
    model_x1_x2_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8), use_mkira=False, mkira_up_indices=(1, 2, 3), mkira_init_alpha=0.0),
...
checkpoint_path_x1_x2_x3 =  "results/GPSTFDiff/syy_setting-9/CIA/ablation/MKIRA/results_no_MKIRA/checkpoints/best_model_epoch_249.pth"
checkpoint_path_x2_x3 =     "results/GPSTFDiff/syy_setting-9/CIA/ablation/MKIRA/results_no_MKIRA/checkpoints/best_model_epoch_249.pth"
checkpoint_path_x3 =        "results/GPSTFDiff/syy_setting-9/CIA/ablation/MKIRA/results_no_MKIRA/checkpoints/best_model_epoch_249.pth"
