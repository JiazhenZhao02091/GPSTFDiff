...
model = Diffusion(
    model_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2), use_mkira=True, mkira_up_indices=(1, 2), mkira_init_alpha=0.0),
    model_x2_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2), use_mkira=True, mkira_up_indices=(1, 2), mkira_init_alpha=0.0),
    model_x1_x2_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2), use_mkira=True, mkira_up_indices=(1, 2), mkira_init_alpha=0.0),
