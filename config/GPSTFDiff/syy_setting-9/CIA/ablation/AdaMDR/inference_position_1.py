...
model = Diffusion(
    model_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8), use_mkira=True, mkira_up_indices=(1,), mkira_init_alpha=0.0),
    model_x2_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8), use_mkira=True, mkira_up_indices=(1,), mkira_init_alpha=0.0),
    model_x1_x2_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8), use_mkira=True, mkira_up_indices=(1,), mkira_init_alpha=0.0),
    model = PredNoiseNetMKIRA(dim=64, channels=6, out_dim=6, dim_mults=(1, 2, 4), use_mkira=True, mkira_up_indices=(1,), mkira_init_alpha=0.0),
    sampling_timesteps=100,
    image_size=256,
)

checkpoint_path_x1_x2_x3 =  "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/position_1/checkpoints/best_model_epoch_149.pth"
checkpoint_path_x2_x3 =     "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/position_1/checkpoints/best_model_epoch_149.pth"
checkpoint_path_x3 =        "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/position_1/checkpoints/best_model_epoch_149.pth"
