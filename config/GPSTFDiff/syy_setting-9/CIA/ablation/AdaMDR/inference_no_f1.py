...
model = Diffusion(
    model_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8), use_mkira=True, mkira_up_indices=(1, 2), mkira_init_alpha=0.0, include_f1_in_cond = False),
    model_x2_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8), use_mkira=True, mkira_up_indices=(1, 2), mkira_init_alpha=0.0, include_f1_in_cond = False),
    model_x1_x2_x3 = PredNoiseNetMKIRA(dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8), use_mkira=True, mkira_up_indices=(1, 2), mkira_init_alpha=0.0, include_f1_in_cond = False),
    model = PredNoiseNetMKIRA(dim=64, channels=6, out_dim=6, dim_mults=(1, 2, 4), use_mkira=True, mkira_up_indices=(1, 2), mkira_init_alpha=0.0, include_f1_in_cond = False),
    sampling_timesteps=100,
    image_size=256,
)

checkpoint_path_x1_x2_x3 =  "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/no_f1/checkpoints/best_model_epoch_199.pth"
checkpoint_path_x2_x3 =     "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/no_f1/checkpoints/best_model_epoch_199.pth"
checkpoint_path_x3 =        "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/no_f1/checkpoints/best_model_epoch_199.pth"
