...
model = Diffusion(
    model_x3 = PredNoiseNetMKIRA_Abl(
        ...
        use_mkira=True, 
        use_ca=False,   # 测试消除时设为 False
        use_sa=False,  # 测试消除时设为 False
        use_mfe=True, # 设为False退化为只有 (3,) 单尺寸核卷积
...
checkpoint_path_x1_x2_x3 =  "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/net_only_MFE/checkpoints/best_model_epoch_99.pth"
checkpoint_path_x2_x3 =     "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/net_only_MFE/checkpoints/best_model_epoch_99.pth"
checkpoint_path_x3 =        "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/net_only_MFE/checkpoints/best_model_epoch_99.pth"
