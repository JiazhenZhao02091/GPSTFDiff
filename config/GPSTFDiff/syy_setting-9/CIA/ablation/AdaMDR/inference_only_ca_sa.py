...
# from src.model.GPSTFDiff.GPSTFDiff_ablation.net_no_SA import PredNoiseNetMKIRA
from src.model.GPSTFDiff.GPSTFDiff_ablation.net_abl import PredNoiseNetMKIRA_Abl
...
model = Diffusion(
    model_x3 = PredNoiseNetMKIRA_Abl(
        dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8),
        use_mkira=True, 
        use_ca=True,   # 测试消除时设为 False
        use_sa=True,  # 测试消除时设为 False
        use_mfe=False, # 设为False退化为只有 (3,) 单尺寸核卷积
        mkira_up_indices=(1, 2), 
        mkira_init_alpha=0.0
    ),
    model_x2_x3 = PredNoiseNetMKIRA_Abl(
        dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8),
        use_mkira=True, 
        use_ca=True,   # 测试消除时设为 False
        use_sa=True,  # 测试消除时设为 False
    ...
    model_x1_x2_x3 = PredNoiseNetMKIRA_Abl(
        dim=128, channels=6, out_dim=6, dim_mults=(1, 2, 4, 8),
        use_mkira=True, 
        use_ca=True,   # 测试消除时设为 False
        use_sa=True,  # 测试消除时设为 False
...
checkpoint_path_x1_x2_x3 =  "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/net_only_ca_sa/checkpoints/best_model_epoch_199.pth"
checkpoint_path_x2_x3 =     "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/net_only_ca_sa/checkpoints/best_model_epoch_199.pth"
checkpoint_path_x3 =        "results/GPSTFDiff/syy_setting-9/CIA/ablation/AdaMDR/net_only_ca_sa/checkpoints/best_model_epoch_199.pth"
