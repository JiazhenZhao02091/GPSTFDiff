...
from src.model.GPSTFDiff.GPSTFDiff_ablation.mid_image.inferencer_DDIM import GaussianDiffusion
...
model = GaussianDiffusion(
    ...
    image_size=256,
    timesteps=1000,
    sampling_timesteps=100,  # DDIM
    objective="pred_x0",
    ddim_sampling_eta=1.0,
    save_interval=10,
    save_dir="/home/zhaojiazhen/workspace/STF/STF/PPT/midimage/ddim_full"
)
