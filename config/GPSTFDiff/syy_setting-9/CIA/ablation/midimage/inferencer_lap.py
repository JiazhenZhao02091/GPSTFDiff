...
from src.model.GPSTFDiff.GPSTFDiff_ablation.mid_image.diffusion_lap_inferencer import Diffusion
...
model = Diffusion(
    ...
    save_interval = 10,
    T2=300,
    save_dir="/home/zhaojiazhen/workspace/STF/STF/PPT/midimage/lap_full"
)
