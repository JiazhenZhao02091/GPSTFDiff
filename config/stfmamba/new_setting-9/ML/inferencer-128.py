...
test_dataset = dataset_cls_func(
    dataset_name='ML',
    data_root='data/spatio_temporal_fusion/ML/private_data/new_setting-9-128/test/patch',
...
checkpoint_path = 'results/stfmamba/new_setting-9/ML/results/checkpoints/model_epoch_199.pth'
