...
test_dataset = dataset_cls_func(
    dataset_name='ML',
    data_root='data/spatio_temporal_fusion/ML/private_data/test_setting_9-128/test/patch',
...
checkpoint_path = 'results/stfmamba/test_setting-9/ML/results/checkpoints/last_model.pth'
