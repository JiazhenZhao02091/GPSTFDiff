...
test_dataset = dataset_cls_func(
    dataset_name='CIA',
    data_root='data/spatio_temporal_fusion/CIA/private_data/syy_setting-9-128/test/patch',
...
checkpoint_path = 'results/stfmamba/syy_setting-9/CIA/results/checkpoints/model_epoch_104.pth'
