...
train_dataset = dataset_cls_func(
    dataset_name="LGC",
    data_root="data/spatio_temporal_fusion/LGC/private_data/syy_setting-9-128/train",
...
val_dataset = dataset_cls_func(
    dataset_name="LGC",
    data_root="data/spatio_temporal_fusion/LGC/private_data/syy_setting-9-128/val",
...
optimizer = partial(torch.optim.Adam, lr=5*1e-4)
...
scheduler = partial(
    torch.optim.lr_scheduler.CosineAnnealingLR, T_max=200, eta_min=1e-5
) 
