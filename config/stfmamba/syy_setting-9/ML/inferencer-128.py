...
test_dataset = dataset_cls_func(
    dataset_name='ML',
    data_root='data/spatio_temporal_fusion/ML/private_data/syy_setting-9-128/test/full',
...
checkpoint_path = 'results/stfmamba/syy_setting-9/ML/results/checkpoints/model_epoch_49.pth'
