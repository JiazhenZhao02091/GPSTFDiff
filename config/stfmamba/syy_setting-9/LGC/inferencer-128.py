...
test_dataset = dataset_cls_func(
    dataset_name='LGC',
    data_root='data/spatio_temporal_fusion/LGC/private_data/syy_setting-9-128/test/full',
...
checkpoint_path = 'results/stfmamba/syy_setting-9/LGC/results/checkpoints/model_epoch_124.pth'
