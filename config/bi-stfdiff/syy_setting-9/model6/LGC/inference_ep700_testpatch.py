...
from src.model.stfdiff.model6 import BiPredNoiseNet, BiGaussianDiffusion
...
checkpoint_path = 'results/bi-stfdiff/syy_setting-9/model6/LGC/Adam_1e-3~PredNoiseNet_64_depth_3~timesteps_100~ddim_50~pred_x0/checkpoints/model_epoch_700.pth'
