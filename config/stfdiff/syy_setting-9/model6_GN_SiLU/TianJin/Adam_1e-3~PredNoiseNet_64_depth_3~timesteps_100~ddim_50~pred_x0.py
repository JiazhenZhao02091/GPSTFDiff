...
train_dataset = dataset_cls_func(
    ...
    data_root="data/spatio_temporal_fusion/Tianjin/private_data/syy_setting-9/train",
...
val_dataset = dataset_cls_func(
    dataset_name="Tianjin",
    data_root="data/spatio_temporal_fusion/Tianjin/private_data/syy_setting-9/val",
