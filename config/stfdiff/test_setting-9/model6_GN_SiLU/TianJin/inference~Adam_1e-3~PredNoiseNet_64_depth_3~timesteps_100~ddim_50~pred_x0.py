...
test_dataset = dataset_cls_func(
    dataset_name="Tianjin",
    data_root="data/spatio_temporal_fusion/Tianjin/private_data/syy_setting-9/test/full",
...
checkpoint_path = "results/stfdiff/syy_setting-9/model6_GN_SiLU/LGC/Adam_1e-3~PredNoiseNet_64_depth_3~timesteps_100~ddim_50~pred_x0/checkpoints/model_epoch_449.pth"
