...
from src.model.dit.model3_5.diffusion_inferencer import Diffusion
from src.model.dit.model3_5.dit import DiT as DiT
...
model = Diffusion(
    model_x3 = DiT(depth=8, hidden_size=768, patch_size=4, num_heads=12, input_size=64, in_channels=6, drop_path_rate=0.0, dropout=0.0),
    model_x2_x3 = DiT(depth=8, hidden_size=768, patch_size=8, num_heads=12, input_size=128, in_channels=6, drop_path_rate=0.0, dropout=0.0),
...
checkpoint_path_x1_x2_x3 = "results/ditstf/syy_setting-9/model3_5/CIA/results_x1_x2_x3/checkpoints/model_epoch_4999.pth"
checkpoint_path_x2_x3 = "results/ditstf/syy_setting-9/model3_5/CIA/results_x2_x3/checkpoints/model_epoch_4999.pth"
checkpoint_path_x3 = "results/ditstf/syy_setting-9/model3_5/CIA/results_x3/checkpoints/model_epoch_4999.pth"
