...
from src.model.dit.model3.addLN_inject.diffusion import Diffusion
from src.model.dit.model3.addLN_inject.dit_flash import DiT
...
scheduler = partial(torch.optim.lr_scheduler.CosineAnnealingLR, T_max=1000, eta_min=1e-6)
scheduler = None
