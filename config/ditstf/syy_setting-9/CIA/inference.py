...
model = GaussianDiffusion(
    model = DiT(depth=12, hidden_size=384, patch_size=8, num_heads=6, input_size=256, in_channels=6, learn_sigma=False),
    image_size=256,
    timesteps=100,
...
checkpoint_path = "results/ditstf/syy_setting-9/CIA/results/checkpoints/model_epoch_4999.pth"
