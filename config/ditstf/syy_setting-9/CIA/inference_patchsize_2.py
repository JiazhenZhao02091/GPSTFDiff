...
from src.model.dit.dit import DiT
from src.model.dit.diffusion import GaussianDiffusion
...
model = GaussianDiffusion(
    model = DiT(depth=6, hidden_size=384, patch_size=4, num_heads=6, input_size=256, in_channels=6, learn_sigma=False),
    image_size=256,
    timesteps=100,
...
checkpoint_path = "results/ditstf/syy_setting-9/CIA/results_patchsize_2/checkpoints/model_epoch_4599.pth"
