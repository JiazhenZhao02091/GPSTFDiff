...
model = GaussianDiffusion(
    model = DiT(depth=28, hidden_size=1152, patch_size=16, num_heads=16, input_size=256),
    image_size=256,
    timesteps=100,
...
checkpoint_path = "results/ditstf/syy_setting-9/LGC/results/checkpoints/model_epoch_499.pth"
