...
from src.model.dit.model3_2_5.dit import DiT
from src.model.dit.model3_2.dit import DiT as DiT_2
...
model = Diffusion(
    model_x3 = DiT_2(depth=8, hidden_size=768, patch_size=4, num_heads=12, input_size=64, in_channels=6, drop_path_rate=0.0, dropout=0.0),
    model_x2_x3 = DiT_2(depth=8, hidden_size=768, patch_size=8, num_heads=12, input_size=128, in_channels=6, drop_path_rate=0.0, dropout=0.0),
    model_x1_x2_x3 = DiT(depth=8, hidden_size=768, patch_size=16, num_heads=12, input_size=256, in_channels=6, drop_path_rate=0.0, dropout=0.0),
...
checkpoint_path_x1_x2_x3 = "results/ditstf/syy_setting-9/model3_2_5/results_x1_x2_x3/checkpoints/model_epoch_4999.pth"
