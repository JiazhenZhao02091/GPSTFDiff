...
train_dataset = dataset_cls_func(
    ...
    data_root="data/spatio_temporal_fusion/McLeanv4/private_data/syy_setting-9/train",
...
val_dataset = dataset_cls_func(
    dataset_name="McLeanv4",
    data_root="data/spatio_temporal_fusion/McLeanv4/private_data/syy_setting-9/val",
