...
train_dataset = dataset_cls_func(
    dataset_name="McLeanv5",
    data_root="data/spatio_temporal_fusion/McLeanv5/private_data/syy_setting-9/train",
...
val_dataset = dataset_cls_func(
    dataset_name="McLeanv5",
    data_root="data/spatio_temporal_fusion/McLeanv5/private_data/syy_setting-9/val",
