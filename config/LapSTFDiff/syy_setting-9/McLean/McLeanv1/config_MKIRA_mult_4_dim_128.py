...
train_dataset = dataset_cls_func(
    dataset_name="McLean",
    data_root="data/spatio_temporal_fusion/McLean/private_data/syy_setting-9/train",
...
val_dataset = dataset_cls_func(
    dataset_name="McLean",
    data_root="data/spatio_temporal_fusion/McLean/private_data/syy_setting-9/val",
