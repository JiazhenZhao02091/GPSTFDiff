...
test_dataset = dataset_cls_func(
    dataset_name="McLean",
    data_root="data/spatio_temporal_fusion/McLeanv2/private_data/syy_setting-9/test/full",
...
checkpoint_path = "results/LapSTFDiff/syy_setting-9/McLean/results_MKIRA_mult_4_dim_128/checkpoints/best_model_epoch_99.pth"
