...
train_dataset = dataset_cls_func(
    dataset_name="McLeanv3",
    data_root="data/spatio_temporal_fusion/McLeanv3/private_data/syy_setting-9/train",
...
val_dataset = dataset_cls_func(
    dataset_name="McLeanv3",
    data_root="data/spatio_temporal_fusion/McLeanv3/private_data/syy_setting-9/val",
