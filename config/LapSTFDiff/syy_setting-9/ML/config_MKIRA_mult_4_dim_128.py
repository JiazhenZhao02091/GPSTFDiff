...
from src.model.LapSTFDiff import PredNoiseNetMKIRA, GaussianDiffusion
...
train_transform_list = [
    ...
    RescaleToMinusOneOne(key_list=transforms_key_list, data_range=[0, 1]),  # 原始数据这里是 0-1 之间的float32
