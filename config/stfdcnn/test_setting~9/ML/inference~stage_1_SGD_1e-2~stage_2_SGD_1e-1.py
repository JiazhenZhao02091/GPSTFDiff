...
test_dataset = dataset_cls_func(
    dataset_name='ML',
    data_root='data/spatio_temporal_fusion/ML/private_data/test_setting_9/test/patch',
...
model_stage_1 = STFDCNN(input_channels=img_channel_num, out_channels=img_channel_num)
model_stage_2 = STFDCNN(input_channels=img_channel_num, out_channels=img_channel_num)
checkpoint_stage_1_path = (
    'results/stfdcnn/test_setting~9/ML/stage_1_SGD_1e-2/checkpoints/model_epoch_999.pth'
)
checkpoint_stage_2_path = (
    'results/stfdcnn/test_setting~9/ML/stage_2_SGD_1e-1/checkpoints/model_epoch_999.pth'
)
