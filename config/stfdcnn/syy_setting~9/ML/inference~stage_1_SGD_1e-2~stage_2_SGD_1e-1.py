...
test_dataset = dataset_cls_func(
    dataset_name='ML',
    data_root='data/spatio_temporal_fusion/ML/private_data/syy_setting-9/test/patch',
...
checkpoint_stage_1_path = (
    'PPT/checkpoints/ML/stfdcnn/stage1/model_epoch_999.pth'
)
checkpoint_stage_2_path = (
    'PPT/checkpoints/ML/stfdcnn/stage2/model_epoch_999.pth'
)
