...
import sys
import os
sys.path.append(os.path.join(os.getcwd(), 'src', 'model', 'LapSTF', 'zigma'))
...
from src.model.UViT.model2.diffusion import Diffusion
from src.model.UViT.model2.UViT import UViT
...
model = Diffusion(
    model = ZigMa(
        in_channels= img_channel_num * 4,
        out_channels= img_channel_num,
        embed_dim=768,
        depth=12,
        img_dim=img_size,
        patch_size=2,
