...
from src.model.dino.dino_silu.dino import Dino
...
checkpoint_path = "results/dinostf/syy_setting-9/dino_activation/hot/results/checkpoints/model_epoch_999.pth"
