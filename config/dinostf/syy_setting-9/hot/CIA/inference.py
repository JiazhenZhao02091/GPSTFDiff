...
test_dataset = dataset_cls_func(
    dataset_name='CIA',
    data_root='data/spatio_temporal_fusion/CIA/private_data/syy_setting-9/val',  # TODO: swintransformer怎么操作的？
...
checkpoint_path = "results/dinostf/syy_setting-9/hot/CIA/results/checkpoints/model_epoch_999.pth"
