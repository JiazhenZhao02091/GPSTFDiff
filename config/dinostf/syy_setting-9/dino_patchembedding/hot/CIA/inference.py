...
from src.model.dino.dino_patch.dino import Dino
...
checkpoint_path = "results/dinostf/syy_setting-9/dino_patchembedding/hot/CIA/results/checkpoints/model_epoch_999.pth"
