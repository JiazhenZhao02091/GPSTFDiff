...
from src.model.dino.dino_patch_position_activation.dino import Dino
...
checkpoint_path = "results/dinostf/syy_setting-9/dino_patch_position_activation/hot/CIA/results/checkpoints/model_epoch_999.pth"
