...
from src.model.dino.dino_position.dino import Dino
...
checkpoint_path = "results/dinostf/syy_setting-9/dino_position/hot/results/checkpoints/model_epoch_999.pth"
